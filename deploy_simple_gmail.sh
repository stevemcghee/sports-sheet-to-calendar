...
# Simple deployment for Gmail accounts
# Uses service account for deployment, OAuth2 for calendar access
...
print_status "Setting up simple deployment for Gmail accounts..."
...
print_status "Setting up OAuth2 credentials for Gmail accounts..."
...
echo "   - Add test users: smcghee@gmail.com, sloswimtiming@gmail.com"
echo ""
...
echo "   - Sign in as smcghee@gmail.com"

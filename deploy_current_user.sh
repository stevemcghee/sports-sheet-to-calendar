...
# Deployment script for current user (smcghee@gmail.com) to access sloswimtiming@gmail.com's calendars
# This uses OAuth2 with calendar sharing
...
print_status "Setting up deployment for current user to access sloswimtiming@gmail.com's calendars..."
...
print_status "Setting up OAuth2 credentials for calendar access..."
...
echo "   - Add test users: $CURRENT_USER, sloswimtiming@gmail.com"
echo ""
...
echo "   - Add $CURRENT_USER with 'Make changes to events' permission"
echo ""
...
echo "   - Sign in as $CURRENT_USER"
echo "   - Grant permissions to access sloswimtiming@gmail.com's calendars"
echo ""

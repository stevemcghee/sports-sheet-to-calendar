...
# Cross-Account Google Cloud Run Deployment Script
# This script sets up deployment under smcghee@gmail.com to access sloswimtiming@gmail.com's calendars
...
print_status "Setting up cross-account calendar access..."
echo ""
echo "This script will help you set up:"
echo "  - Deployment account: smcghee@gmail.com"
echo "  - Calendar owner: sloswimtiming@gmail.com"
echo ""
...
if [[ "$CURRENT_USER" != "smcghee@gmail.com" ]]; then
    print_warning "You are not authenticated as smcghee@gmail.com!"
    echo "Please run: gcloud auth login"
    echo "Then authenticate as smcghee@gmail.com"
    exit 1
fi
...
echo ""
print_warning "IMPORTANT: Manual steps required for sloswimtiming@gmail.com:"
echo ""
echo "1. sloswimtiming@gmail.com needs to grant calendar access:"
echo "   - Go to: https://console.cloud.google.com/apis/credentials"
echo "   - Create OAuth 2.0 Client ID (if not exists)"
echo "   - Add smcghee@gmail.com as a test user"
echo ""
echo "2. sloswimtiming@gmail.com needs to share calendars:"
echo "   - Go to: https://calendar.google.com"
echo "   - Right-click on each calendar"
echo "   - Settings and sharing"
echo "   - Add smcghee@gmail.com with 'Make changes to events' permission"
echo ""
echo "3. sloswimtiming@gmail.com needs to enable calendar API:"
echo "   - Go to: https://console.cloud.google.com/apis/library"
echo "   - Enable Google Calendar API"
echo ""

read -p "Press Enter when sloswimtiming@gmail.com has completed these steps..."

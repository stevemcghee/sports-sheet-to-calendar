...
# Deployment script using existing Google Cloud project and OAuth credentials
# This assumes smcghee@gmail.com already has a project with OAuth credentials set up
...
print_status "Deploying with existing Google Cloud project and OAuth credentials..."
...
print_status "Checking existing OAuth credentials..."

# List existing OAuth credentials
print_status "Existing OAuth 2.0 Client IDs:"
...
echo ""
echo "1. sloswimtiming@gmail.com needs to share calendars:"
...
echo ""
echo "2. sloswimtiming@gmail.com needs to enable calendar API:"

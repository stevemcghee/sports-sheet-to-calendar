...
from calendar_sync import parse_date_range
...
class TestCalendarSync(unittest.TestCase):
    ...
    def test_parse_date_range_single_month(self):
        ...
        start_date, end_date = parse_date_range("2/15-17/2025")
    ...
    def test_parse_date_range_multiple_months(self):
        ...
        start_date, end_date = parse_date_range("7/28-8/1/2025")
    ...
    def test_parse_date_range_multiple_years(self):
        ...
        start_date, end_date = parse_date_range("12/28/2024-1/5/2025")
